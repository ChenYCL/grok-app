...
"error.needTauri": "Folder picker requires the Tauri window",
  ...
  "settings.remoteIm.telegram.tokenHelp": "Token from @BotFather (/newbot or /token). Stored masked; never logged.",
...
"error.needTauri": "需要在 Tauri 窗口中选择目录",
  ...
  "settings.remoteIm.telegram.tokenHelp": "来自 @BotFather（/newbot 或 /token）的 Token。默认遮罩存储，不入日志。",
  "settings.remoteIm.telegram.tokenPlaceholder": "123456789:AAH…",
