...
"settings.prefsScope": "Remember model & permission at",
  ...
  "prov.ccSwitch.status.exists": "Already imported",
  "prov.ccSwitch.status.invalid": "Invalid",
  "prov.ccSwitch.conflict": "If id already exists",
  "prov.ccSwitch.conflict.skip": "Skip",
  "prov.ccSwitch.conflict.overwrite": "Overwrite",
  "prov.ccSwitch.conflict.rename": "Rename (…-2)",
  "prov.ccSwitch.activateCurrent":
    "After import, activate the provider that is current in CC Switch",
...
"settings.prefsScope": "模型与权限记忆范围",
  ...
  "prov.ccSwitch.status.exists": "已存在",
  "prov.ccSwitch.status.invalid": "无效",
  "prov.ccSwitch.conflict": "若 id 已存在",
  "prov.ccSwitch.conflict.skip": "跳过",
  "prov.ccSwitch.conflict.overwrite": "覆盖",
  "prov.ccSwitch.conflict.rename": "重命名（…-2）",
  "prov.ccSwitch.activateCurrent": "导入后启用 CC Switch 当前选中的供应商",
