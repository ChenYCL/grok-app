...
"error.needTauri": "Folder picker requires the Tauri window",
  ...
  "settings.remoteIm.discord.intentHint": "In the Discord developer portal → your app → Bot → Privileged Gateway Intents, enable Message Content Intent, then save. Without it the bot cannot read message text.",
...
"error.needTauri": "需要在 Tauri 窗口中选择目录",
  ...
  "settings.remoteIm.discord.intentHint": "在 Discord 开发者后台 → 你的应用 → Bot → Privileged Gateway Intents 中开启 Message Content Intent 并保存。未开启时机器人无法读取消息正文。",
