...
const en = {
  ...
  "composer.worktreeGcHint":
    "Removes administrative records for worktrees whose folders are already gone (git worktree prune). Does not delete live worktrees or branches.",
...
const zh: Record<MessageKey, string> = {
  ...
  "composer.worktreeGcHint":
    "清理已删除目录对应的 worktree 管理记录（git worktree prune）。不会删除仍在使用的 worktree 或分支。",
