...
const en = {
  ...
  "session.exportImageHint":
    "Render this conversation as a branded PNG card. Footer always says “Generated with Grok App”. Optional custom logo is configured in Settings → Appearance → Interface.",
  "session.exportImageIncludeThoughts": "Include thinking",
  "session.exportImageDownload": "Download PNG",
...
const zh: Record<MessageKey, string> = {
  ...
  "session.exportImageHint":
    "将对话渲染为带品牌的 PNG 卡片。页脚固定 “Generated with Grok App”。自定义 Logo 可在 设置 → 外观 → 界面 上传。",
  "session.exportImageIncludeThoughts": "包含思考",
  "session.exportImageDownload": "下载 PNG",
