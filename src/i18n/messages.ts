...
const en = {
  ...
  "composer.goal": "Goal",
  "composer.goalHint": "Continuous goal mode — agent pursues measurable outcomes",
  ...
  "prov.lead":
    "Connect any OpenAI-compatible gateway. Settings are written to the App agent profile and read by Grok Build through GROK_HOME.",
  "prov.listTitle": "Configured",
  "prov.emptyTitle": "No providers yet",
  "prov.empty":
    "Add a base URL and API key from your relay panel. Works with CPA, sub2api, OneAPI, and other OpenAI-compatible endpoints.",
  ...
  "prov.formLead":
    "Required: Base URL and API key. Model can be typed or fetched from the gateway.",
  "prov.name": "Display name",
  "prov.namePh": "e.g. Work relay",
  "prov.nameHint": "Shown in lists and chips.",
  "prov.displayName": "Config id",
  "prov.idPh": "my-relay",
  "prov.idHint": "Stable id for config.toml ([model.id]). Letters, numbers, .-_",
  "prov.baseUrl": "Base URL",
  "prov.baseUrlPh": "https://your-relay.example.com/v1",
  "prov.baseHint": "OpenAI-compatible root. Usually ends with /v1.",
  "prov.protocol": "API protocol",
  "prov.protocolHint": "Pick what your gateway expects. Most relays use Chat Completions.",
  ...
  "prov.apiKey": "API key",
  "prov.keyPh": "sk-…",
  "prov.keyKeep": "Leave blank to keep the saved key",
  "prov.keyHint": "Never logged. Stored only in the local agent profile.",
  "prov.keyShow": "Show",
  "prov.keyHide": "Hide",
  "prov.requestModel": "Request model",
  "prov.modelPh": "e.g. grok-4.5",
  "prov.modelHint": "Value sent as the model field in API requests.",
  "prov.fetchModels": "Fetch models",
  "prov.fetching": "Fetching model list…",
  "prov.loaded": "Loaded {n} models",
  "prov.emptyList": "Gateway returned no models",
  "prov.setDefault": "Set as default for new chats",
  "prov.setDefaultHint": "Writes [models].default in the agent profile.",
  "prov.save": "Save",
  "prov.add": "Add",
  "prov.saving": "Saving…",
  "prov.confirmDelete": "Delete provider “{id}”? This removes its config section.",
  "prov.loading": "Loading providers…",
  "prov.loadingHint": "Reading the local agent profile.",
  "prov.agentHome": "Agent profile",
  "prov.configFile": "Config file",
  "prov.count": "Providers",
  "prov.countValue": "{n}",
  "prov.copyPath": "Copy path",
  "prov.errorTitle": "Something went wrong",
  "prov.factModel": "Model",
  "prov.factEndpoint": "Endpoint",
  "prov.err.needBase": "Base URL is required.",
  "prov.err.needKey": "API key is required for a new provider.",
  "prov.switchTitle": "Active route",
  "prov.switchHint":
    "Switching the active route updates what new Grok Build sessions use.",
  "prov.officialName": "Official Grok",
  "prov.officialDesc": "xAI login / official API key via Grok Build",
  "prov.active": "Active",
  "prov.useThis": "Use",
  "prov.switchedOfficial": "Switched to official Grok route.",
  "prov.switchedCustom": "Switched to custom provider.",
  "prov.switchedHotReload":
    "Provider switched. Next message will start a new Grok Build session with the new config.",
  ...
  "setup.cli.required": "Grok Build is required",
  "setup.cli.requiredHint":
    "This app drives the local Grok Build CLI. Install it before opening the home screen.",
  ...
  "setup.recheck": "I already installed it — recheck",
  "setup.pickBinary": "Choose binary…",
  "setup.copyCmd": "Copy install command",
  "setup.copied": "Copied",
  "setup.openDocs": "Open install docs",
  "setup.manualHint":
    "Auto-install retries multiple mirrors. If the network fails, copy the command or pick a local binary.",
  "setup.mirror": "Mirror: {host}",
  "setup.progress": "{percent}%",
  "setup.continue": "Continue",
  "setup.account.title": "Sign in or connect a provider",
  "setup.account.hint":
    "Optional. You can skip and configure later in Settings.",
  "setup.account.oauth": "Browser OAuth",
  "setup.account.oauthHint": "Sign in with your Grok account (recommended)",
  "setup.account.key": "Official API key",
  "setup.account.keyHint": "Paste a key from console.x.ai",
  "setup.account.keyPh": "xai-…",
  "setup.account.relay": "Custom relay",
  "setup.account.relayHint": "OpenAI-compatible base URL + API key",
  ...
  "setup.networkHint":
    "Network error — auto-retrying other mirrors, or use the manual command.",
  ...
  "automations.menuHint": "Describe a recurring task with natural language",
...
const zh: Record<MessageKey, string> = {
  ...
  "composer.goal": "目标",
  "composer.goalHint": "目标模式 — Agent 持续追求可衡量的成果",
  ...
  "prov.configuredTitle": "自定义提供商",
  "prov.lead":
    "接入任意 OpenAI 兼容网关。配置写入本机 App agent 配置目录，Grok Build 通过 GROK_HOME 读取。",
  "prov.listTitle": "已配置",
  "prov.emptyTitle": "还没有提供商",
  "prov.empty":
    "从你的中转控制台复制 Base URL 与 API Key。兼容 CPA、sub2api、OneAPI 等 OpenAI 兼容端点。",
  "prov.new": "添加提供商",
  "prov.edit": "编辑",
  "prov.delete": "删除",
  "prov.enable": "设为默认",
  ...
  "prov.ping": "连通测试",
  "prov.pinging": "测试中…",
  "prov.pingOk": "可达 · {ms} ms",
  "prov.pingFail": "失败 · {ms} ms",
  "prov.editTitle": "编辑提供商",
  "prov.addTitle": "添加提供商",
  "prov.formLead": "必填：Base URL 与 API Key。模型可手填，也可从网关拉取。",
  "prov.name": "显示名称",
  "prov.namePh": "例如：工作中转",
  "prov.nameHint": "出现在列表与选择器中。",
  "prov.displayName": "配置段 id",
  "prov.idPh": "my-relay",
  "prov.idHint": "写入 config.toml 的稳定 id（[model.id]），可用字母、数字、.-_",
  "prov.baseUrl": "Base URL",
  "prov.baseUrlPh": "https://your-relay.example.com/v1",
  "prov.baseHint": "OpenAI 兼容根路径，通常以 /v1 结尾。",
  "prov.protocol": "API 协议",
  "prov.protocolHint": "按网关要求选择。多数中转使用 Chat Completions。",
  "prov.protocol.chatCompletions": "OpenAI Chat Completions",
  "prov.protocol.responses": "OpenAI Responses",
  "prov.protocol.messages": "Anthropic Messages",
  "prov.apiKey": "API Key",
  "prov.keyPh": "sk-…",
  "prov.keyKeep": "留空则保留已保存的 Key",
  "prov.keyHint": "不会写入日志，仅保存在本机 agent 配置中。",
  "prov.keyShow": "显示",
  "prov.keyHide": "隐藏",
  "prov.requestModel": "请求模型",
  "prov.modelPh": "例如 grok-4.5",
  "prov.modelHint": "作为请求体中的 model 字段发送。",
  "prov.fetchModels": "拉取模型",
  "prov.fetching": "正在拉取模型列表…",
  "prov.loaded": "已加载 {n} 个模型",
  "prov.emptyList": "网关未返回模型列表",
  "prov.setDefault": "设为新对话默认",
  "prov.setDefaultHint": "写入 agent 配置中的 [models].default。",
  "prov.save": "保存",
  "prov.add": "添加",
  "prov.saving": "保存中…",
  "prov.confirmDelete": "删除提供商「{id}」？将移除对应配置段。",
  "prov.loading": "正在加载提供商…",
  "prov.loadingHint": "读取本机 agent 配置。",
  "prov.agentHome": "Agent 配置目录",
  ...
  "prov.err.needKey": "新建提供商必须填写 API Key。",
  "prov.switchTitle": "当前路由",
  "prov.switchHint": "切换激活路由后，新的 Grok Build 会话将使用该配置。",
  "prov.officialName": "官方 Grok",
  "prov.officialDesc": "Grok Build 官方登录 / 官方 API Key",
  "prov.active": "使用中",
  "prov.useThis": "使用",
  "prov.switchedOfficial": "已切换到官方 Grok 路由。",
  "prov.switchedCustom": "已切换到自定义提供商。",
  "prov.switchedHotReload":
    "已切换服务商。下一条消息会用新配置启动新的 Grok Build 会话。",
  "common.cancel": "取消",
  "common.confirm": "确认",
  "common.save": "保存",
  "common.dismiss": "关闭",
  ...
  "setup.cli.requiredHint":
    "本应用通过本机 Grok Build CLI 驱动对话。进入首页前必须完成安装。",
  ...
  "setup.recheck": "我已安装，重新检测",
  "setup.pickBinary": "选择本地二进制…",
  "setup.copyCmd": "复制安装命令",
  "setup.copied": "已复制",
  "setup.openDocs": "打开安装文档",
  "setup.manualHint":
    "自动安装会在多个镜像间重试。若网络失败，可复制命令或手动选择二进制。",
  "setup.mirror": "镜像：{host}",
  "setup.progress": "{percent}%",
  "setup.continue": "继续",
  "setup.account.title": "登录或接入服务商",
  "setup.account.hint": "可选。可先跳过，稍后在设置中配置。",
  "setup.account.oauth": "浏览器 OAuth",
  "setup.account.oauthHint": "使用 Grok 账号登录（推荐）",
  "setup.account.key": "官方 API Key",
  "setup.account.keyHint": "粘贴 console.x.ai 的密钥",
  "setup.account.keyPh": "xai-…",
  "setup.account.relay": "自定义中转",
  "setup.account.relayHint": "OpenAI 兼容 base URL + API Key",
  "setup.account.basePh": "https://api.example.com/v1",
  "setup.account.relayKeyPh": "API Key",
  ...
  "setup.error": "出错了",
  "setup.networkHint": "网络异常 — 正在切换镜像重试，或使用手动命令。",
  ...
  "automations.menuHint": "用自然语言描述周期任务",
