...
const en = {
  ...
  "project.reveal": "Reveal in file manager",
  ...
  "attach.open": "Open",
  "attach.reveal": "Reveal in file manager",
  "attach.copyPath": "Copy path",
  "attach.copyImage": "Copy image",
  "attach.addToComposer": "Add to input",
  "attach.droppedNone":
    "Could not read dropped paths. Try again from your file manager.",
  ...
  "settings.openFinder": "Finder / Explorer / Files",
  ...
  "session.exportImageHint": "Export chat as image",
...
const zh: Record<MessageKey, string> = {
  ...
  "attach.droppedNone": "无法读取拖入的路径，请从文件管理器再试一次。",
  "attach.details": "详情",
  ...
  "settings.openFinder": "访达 / 资源管理器 / 文件管理器",
  ...
  "session.exportImageHint": "导出对话为图片",
