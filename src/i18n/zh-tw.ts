...
"error.needTauri": "需要在 Tauri 視窗中選擇目錄",
  ...
  "settings.remoteIm.security.lead":
    "誠實展示 allow-from ACL、入站限速、Bridge 健康、手機鏡像寫入預設與遠端 YOLO — 無 Bridge 關聯時絕不聲稱渠道已上線。",
  ...
  "settings.remoteIm.security.confirmsLead":
    "以下操作使用應用內確認（GlassModal）— 從不使用瀏覽器 window.confirm。僅為清單。",
  "settings.remoteIm.security.honesty":
    "軟誠實：無 Bridge 關聯不聲稱 live WS/Gateway；摘要已脫敏（無 token/URL）。",
  ...
  "settings.remoteIm.security.detail.liveNotLinked":
    "Bridge 在監聽但尚未關聯渠道 — 請勿聲稱 live WS/Gateway。",
