...
export const zhTW: Record<MessageKey, string> = {
  ...
  "settings.openFinder": "Finder / 檔案總管 / 檔案管理員",
  ...
  "session.exportImageHint": "匯出對話為圖片",
