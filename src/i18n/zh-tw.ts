...
"settings.prefsScope": "模型與權限記憶範圍",
  ...
  "prov.ccSwitch.conflict.skip": "略過",
  "prov.ccSwitch.conflict.overwrite": "覆蓋",
  "prov.ccSwitch.conflict.rename": "重新命名（…-2）",
  "prov.ccSwitch.activateCurrent": "匯入後啟用 CC Switch 目前選中的供應商",
