 ...
 * newer app version is known. Startup discovery lives in `useUpdater`; click
 * runs the same path as Settings → About (silent install + relaunch, or
 * open GitHub when only manual download is available).
 */
...
import { isUpdateAffordanceVisible } from "@/lib/appUpdateHonesty";
